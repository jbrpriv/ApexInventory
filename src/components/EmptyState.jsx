...
export default function EmptyState({ title, message, action }) {
  return (
    ...
    >
      ...
      <div style={{ fontFamily:'var(--font-display)', fontSize:18, fontWeight:700, color:'white' }}>{title}</div>
      <div style={{ fontSize:14, color:'rgba(255,255,255,0.4)', maxWidth:340, lineHeight:1.65 }}>{message}</div>
