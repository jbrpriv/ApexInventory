  ...
  return ReactDOM.createPortal(
    ...
    >
      <motion.div initial={{ scale:0.9, opacity:0, y:20 }} animate={{ scale:1, opacity:1, y:0 }} transition={{ type:'spring', stiffness:300, damping:28 }}
        ...
        style={{ background:'var(--surface)', border:`1px solid ${danger?'rgba(244,63,94,0.3)':'rgba(234,88,12,0.3)'}`, borderRadius:20, width:'100%', maxWidth:380, overflow:'hidden', boxShadow:'0 24px 64px rgba(0,0,0,0.25)' }}
      >
